$(document).ready(function () {
    ...
    $("#form-segundas-constancia").on("submit", function (e) {
        e.preventDefault();
        $("#codigo").val(tmp);
        spinner.show();
        var formDerivar = document.getElementById("form-segundas-constancia");
    ...
    $(".escuela").change(function (e) {
        if ($(this).val() != null && $(this).val() != "") {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: "../estudianteDobleSegundas/" + tmp,
                headers: {
                    "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr(
                        "content"
                    ),
